...
NAME="Deadline Delirium"
PROJ="deadlinedelirium"
ARCH="x86_64"
DATA="data"
DEPS="\
...
wget -O AppRun https://github.com/probonopd/AppImageKit/releases/download/continuous/AppRun-x86_64
chmod +x AppRun

cd ..
wget -N https://github.com/probonopd/AppImageKit/releases/download/continuous/appimagetool-x86_64.AppImage
chmod +x appimagetool-x86_64.AppImage
ARCH=$ARCH ./appimagetool-x86_64.AppImage "$PROJ.AppDir" "$PROJ-$ARCH.AppImage"
